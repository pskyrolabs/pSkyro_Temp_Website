    ...
    <>
      ...
      <section className="px-3 sm:px-5 lg:px-8 pt-3 sm:pt-5">
        <div className="relative mx-auto max-w-site 2xl:max-w-site-wide overflow-hidden rounded-[20px] sm:rounded-[28px] lg:rounded-[34px]" style={{ background: "radial-gradient(120% 90% at 18% 8%, #4b34e0 0%, #2400C2 26%, #160089 52%, #0a0440 76%, #04021c 100%)" }}>
          ...
          <div className="relative flex min-h-[78vh] flex-col justify-between px-5 sm:px-8 lg:px-12 py-7 sm:py-10 lg:py-14">
            <div className="flex items-start justify-between">
              ...
              <div className="floaty relative hidden sm:block" style={{ width: "clamp(120px,11vw,190px)", height: "clamp(120px,11vw,190px)", animation: "floatY 6s ease-in-out infinite" }}>
                <div className="orbit absolute inset-0 rounded-full border border-white/15" style={{ animation: "orbitSpin 16s linear infinite" }}>
                  <span className="absolute left-1/2 top-0 h-1.5 w-1.5 -translate-x-1/2 rounded-full bg-launch" />
                </div>
                <div className="absolute inset-[18%] rounded-full" style={{ background: "radial-gradient(circle at 35% 30%, rgba(255,255,255,.9), rgba(120,110,180,.25) 55%, rgba(20,10,80,.4))", boxShadow: "inset 0 0 30px rgba(0,0,0,.5)" }}>
                  <span className="pdot absolute left-1/2 top-1/2 h-1.5 w-1.5 -translate-x-1/2 -translate-y-1/2 rounded-full bg-white" style={{ animation: "pulseDot 2.6s ease-in-out infinite" }} />
                </div>
              </div>
            </div>
            <Reveal className="max-w-[20ch]">
              <h1 className="font-semibold leading-[0.92] tracking-[-0.025em]" style={{ fontSize: "clamp(34px,5.6vw,92px)" }}>
                <span className="text-white">We design and build</span><br />
                <span className="text-white">experiences that</span><br />
                <span className="text-white/40">refuse to blend in</span>
              </h1>
            </Reveal>
            <div className="flex flex-wrap items-end justify-between gap-4">
              <span className="inline-flex items-center gap-2 rounded-full bg-white/10 px-4 py-2 text-[12px] sm:text-[13px] font-medium text-white/85 ring-1 ring-white/15">
                <span className="h-1.5 w-1.5 rounded-full bg-launch" /> Not built to blend in
              </span>
            </div>
          </div>
        </div>
